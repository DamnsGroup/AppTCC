...
export default function Usuario() {
  ...
  const navigation = useNavigation(); 
    ...
    async function loadData() {        
      try {
          const response = await api.get(`pam3etim/bd/usuarios/vazamento.php?pagina=${page}&limite=10`);
  ...
  return (
    <View style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1, backgroundColor: '#fff'}}>
              ...
              <Text style={styles.primaryTilt}>Gás</Text>
              </View>     
              ...
              <Text style={styles.grafic}>Vazamento na sua casa</Text>
