...
export default function Usuario() {
  ...
  const navigation = useNavigation(); 
    ...
    async function loadData() {        
      try {
          const response = await api.get(`pam3etim/bd/usuarios/dados.php?pagina=${page}&limite=10`);
  ...
  return (
    <View style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1, backgroundColor: '#fff'}}>
              ...
              <Text style={styles.primaryTilt}>Incêncio</Text>
              </View>     
              ...
              <Text style={styles.grafic}>Registros da Temperatura da sua casa</Text>
