...
import Grid from '../../components/Grids/sensor';
...
export default function Usuario() {
  ...
  const navigation = useNavigation(); 
    ...
    async function loadData() {        
      try {
          const response = await api.get(`pam3etim/bd/usuarios/proximidade.php?pagina=${page}&limite=10`);
  ...
  return (
    <View style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1, backgroundColor: '#fff'}}>
              ...
              <Text style={styles.primaryTilt}>Sensor</Text>
              </View>     
              ...
              <Text style={styles.grafic}>Aproximidade da sua casa</Text>
